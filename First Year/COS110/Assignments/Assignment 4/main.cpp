...
int main()
{
    ...
    test.insert(0, 90);
    cout << test << endl;
    cout << test.remove(0) << endl;
    cout << test << endl;
    cout << test.remove(4) << endl;
    cout << "REMOVE NOW" << endl;
    test.clear();
    cout << test << endl;

    LinkedList<int> copy(test);
    cout << "COPY CONST = " << &copy << endl;

    LinkedList<int> * clone = copy.clone();
    cout << "CLONSE NEW = " << clone << endl;

    LinkedList<int> copy(test);
    cout << copy << endl;
    LinkedList<int> overloadCopy;
    overloadCopy = copy;
    cout << overloadCopy << endl;

    cout << "test: " << &test << endl << "copy: " << &copy << endl << "overloadCopy: " << &overloadCopy << endl;
...
void task4() {
    ...
    cout << "///////////////" << endl;
    Stack<char> copy = s1;
    cout << "COPY ===== " << *copy.getImplementation() << endl;
    cout << "///////////////" << endl;
...
void task5() {
    ...
    cout << "/////////////" << endl;
    Queue<char> copy = q1;
    cout << "COPIED = " << *copy.getImplementation() << endl;
    cout << &q1 << endl << &copy << endl;
    cout << "/////////////" << endl;
...
void task6() {
    ...
    cout << "//////////////" << endl;
    PriorityQueue<int>  copy = pq1;
    cout << *copy.getImplementation() << endl;
    cout << "//////////////" << endl;
    cout << endl;
