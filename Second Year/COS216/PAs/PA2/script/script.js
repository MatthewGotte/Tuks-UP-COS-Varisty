...
function onTrendingload() {
    ...
    req.open("GET", "https://api.rawg.io/api/games?key=18c49c41da8d46e989fb669496a615ee&dates=2019-09-01,2019-09-30&platforms=18,1,7", true);
    req.send();
}
...
function populateTrending(obj) {
    ...
    for (var i = 0; i < 10; i++) {
        ...
        req.open("GET", 'https://api.rawg.io/api/games/' + obj[i].id + '?key=18c49c41da8d46e989fb669496a615ee&dates=2019-09-01,2019-09-30&platforms=18,1,7', false);
        req.send();
        console.log(temp);
        var developers = "";
            ...
            for (var p = 0; p < 2; p++) {
                ...
                var tempname = name.replace(/\s/g, '-');
                        ...
                        try {
                            ...
                            req.open("GET", 'https://api.rawg.io/api/games/' + tempname + '?&key=18c49c41da8d46e989fb669496a615ee&dates=2019-09-01,2019-09-30&platforms=18,1,7', false);
                            req.send();
                        }
                        catch (e) {
                        }
...
function createCalendar(year, month) {
    ...
    if (api1 == null) {
        ...
        req.open("GET", "https://api.rawg.io/api/games?key=18c49c41da8d46e989fb669496a615ee&dates=2019-09-01,2019-09-30&platforms=18,1,7", false);
        req.send(); 
    }
